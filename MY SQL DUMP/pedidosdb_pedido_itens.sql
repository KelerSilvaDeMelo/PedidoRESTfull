...
CREATE TABLE `pedido_itens` (
  ...
  CONSTRAINT `pedido_itens_ibfk_1` FOREIGN KEY (`numero_pedido`) REFERENCES `pedidos` (`numero_pedido`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `pedido_itens_ibfk_2` FOREIGN KEY (`codigo_produto`) REFERENCES `produtos` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `pedido_itens` VALUES (1,1,1,2.0000,50.00,100.00),(2,1,2,1.0000,50.00,50.00);
